            ...
            >
              <div className="space-y-4 text-center mt-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-indigo-200 px-4">
            ...
            >
              <div className="space-y-4">
                <div className="bg-slate-900/60 border border-white/10 rounded-2xl p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs text-slate-400 block">Ketik Kata (Huruf Besar):</label>
                    <input
                      type="text"
                      value={textToEncrypt}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-slate-800/40 border border-white/5 rounded-xl p-3 text-center">
                    <span className="text-xs text-slate-400 block font-bold">KATA ASLI</span>
                  ...
                  <div className="bg-indigo-900/40 border border-indigo-500/20 rounded-xl p-3 text-center">
                    <span className="text-xs text-indigo-300 block font-bold">KODE RAHASIA</span>
            ...
            >
              <div className="space-y-4">
                <div className="bg-slate-900/60 border border-white/10 rounded-2xl p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs text-slate-400 block">Ketik Hasil Dekripsi (Petunjuk: Geser mundur 3 huruf! K → H, D → A, W → T, L → I):</label>
                    <input
                      type="text"
                ...
                {errorMsg && (
                  <div className="bg-rose-950/40 border border-rose-500/20 p-2.5 rounded-xl text-xs text-rose-300 flex items-start gap-1.5 leading-snug">
            ...
            >
              ...
              <div>
                ...
                <div className="mt-4 inline-block bg-white/10 border border-white/20 px-5 py-2 rounded-xl">
                  <span className="text-xs text-white/50 block font-bold">SKOR KRIPTOGRAFI</span>
